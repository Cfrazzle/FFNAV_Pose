function [Phi, F] = FFNAV_EKF_STM(state_pre, T, mu)
...
%
% Created by: Cory Fraser - AUG 31, 2017
...
% =========================================================================  
%% Partial derivatives of the 5 non-linear equations
...
% =========================================================================
%% Assembling the Jacobian (10x10 Matrix)
    F11 = zeros(5,5);
    F12 = eye(5,5);
...
% =========================================================================   
%% Calculate the approximate state transition matrix, Phi = expm(F_k*T)
